...
height="2.359722222222222in"}Như dự đoán thì thử khai thác lỗ hổng xxe ở
trường dữ liệu answer vì nó sẽ hiện thông báo bạn đã chọn đáp án X (với
X là giá trị của trường answer )

Và ta đọc src /app/app.py thì có được tên cờ

![A screenshot of a computer AI-generated content may be
incorrect.](media/image5.png){width="6.5in" height="1.95625in"}
